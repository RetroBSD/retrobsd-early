...
extern unsigned int spi_transfer(int dno, unsigned int data);
...
extern void spi_bulk_write(int dno, unsigned int len, char *data);
...
extern void spi_bulk_read(int dno, unsigned int len, char *data);
...
extern void spi_bulk_rw(int dno, unsigned int len, char *data);
