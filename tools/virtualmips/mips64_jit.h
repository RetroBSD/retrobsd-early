...
static forced_inline 
int mips64_jit_tcb_match(cpu_mips_t *cpu,mips64_jit_tcb_t *block,m_va_t vaddr)
{
   m_va_t vpage;
...
*/
static forced_inline m_uint32_t mips64_jit_get_pc_hash(cpu_mips_t *cpu,m_va_t pc)
{
...
static forced_inline void jit_handle_self_write(cpu_mips_t *cpu,m_va_t vaddr)
{
	m_uint32_t pc_hash;
   	mips64_jit_tcb_t *block;
