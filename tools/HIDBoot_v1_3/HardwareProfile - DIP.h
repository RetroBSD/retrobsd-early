...
#define HARDWARE_PROFILE_UBW32_H
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATECLR = 0xF0; TRISECLR = 0xF0;

    #define mLED_1              LATEbits.LATE7
    #define mLED_2              LATEbits.LATE6
    #define mLED_3              LATEbits.LATE5
    #define mLED_4              LATEbits.LATE4
    ...
    /** SWITCH *********************************************************/
    #define mInitSwitch2()      TRISGbits.TRISG6=1;
    #define mInitSwitch3()      TRISGbits.TRISG7=1;
    #define mInitAllSwitches()  mInitSwitch2();mInitSwitch3();
    #define sw2                 PORTGbits.RG6
